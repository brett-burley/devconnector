...
router.put(
    ...
    async (req, res) => {
        ...
        try {
            ...
            // Add new experience to the front of experience
...
// Delete a user profile experience
...
// Delete a user profile education
...
router.get('/gihub/:username', (req, res) => {
    try {
        const options = {
            uri: `https://api.github.com/user/${req.params.username}/repos?per_page=5&sort=created:asc&client_id=${config.get('githubClientId')}&client_secret=${config.get('githubClientSecret')}`,
            method: 'GET',
